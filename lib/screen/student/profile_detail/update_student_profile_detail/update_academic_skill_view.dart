...
class UpdateAcademicSkillView extends StatefulWidget {
  final String id;
  const UpdateAcademicSkillView({super.key, required this.id});

  @override
  State<UpdateAcademicSkillView> createState() =>
      _UpdateAcademicSkillViewState();
}

class _UpdateAcademicSkillViewState
    extends State<UpdateAcademicSkillView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<UpdateStudentProfileProvider>()
          .getPsychoStudentSkillData(context, widget.id, '2');
    });
  }
                        ...
                        if ((skill.skillQualityParent ?? []).isNotEmpty) {
                          return Column(
                            ...
                            children: [
                              ...
                              CustomText(text: '${index + 1}. ${skill.name ?? ''}',fontSize: 15.sp,
